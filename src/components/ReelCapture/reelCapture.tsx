...
export default function ReelCapture({ isFront }: { isFront: boolean }){
        ...
        <View style={{flex: 1}}>
         ...
         {  editCaptureModal?
                  <>
                      ...
                      <EditMediaCapture mode={'reel'} video={video} setVideo={setVideo} photo={image} setImage={setImage} editCaptureModal={editCaptureModal} setEditCaptureModal={setEditCaptureModal} filterMatrice={currentViewableMedia?.item.matrice}  /> 
                  </>
                   : 
